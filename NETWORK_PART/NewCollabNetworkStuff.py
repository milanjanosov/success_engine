...
def get_backboned_edgelists():
    ...
    #for nc in [300000, 150000, 100000, 35000, 14000, 50, 30, 20, 10, 5, 1]:
    for nc in [300000, 150000, 100000, 50000, 35000, 20000, 14000, 10000, 5000, 2000, 1000, 500, 100, 50, 30, 20, 10, 5, 1]:
...
def get_centralities_igraph():
    ...
    params    = [300000, 150000, 100000, 50000, 35000, 20000, 14000, 10000, 5000, 2000, 1000, 500, 100, 50, 30, 20, 10, 5, 1]

...
def get_imapct_distr():             
    ...
    for normalize in ['no', 'yearly_avg', 'years_all', 'field_avg' ,  'fields_all'][2:3]:
        ...
        FOLDER    = '../ProcessedData_all_years/ProcessedDataNormalized_years_all'   
        ...
        for (label, fn) in fields:
            ...
            p = Process(target = fit.fitLognormal, args=(file_cnt, ax[1,0], label, 'ResultData/1_impact_distributions', 'impact_distributions', 100, True, 0, normalize, ))

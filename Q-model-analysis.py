...
def randn_skew_fast(N, alpha, loc, scale):
...
def do_the_r_model():
    ...
    for (label, color) in professions[0:1]:
        ...
        plot_max_impact_N(FOLDER + '/10_career_length_max_impact/career_length_max_avg_rat'   + field + '_' + label + '.dat', ax[0,0], num_of_bins, 'norm', params, True)
        ...
        params = [5.0, 1.46751292815]
        plot_max_impact_N(FOLDER + '/10_career_length_max_impact/career_length_max_rat_cnt'   + field + '_' + label + '.dat', ax[0,1], num_of_bins, 'power', params, True)
        
        
        params = [1.0, 1.78184948609]
        plot_max_impact_N(FOLDER + '/10_career_length_max_impact/career_length_max_crit_rev'   + field + '_' + label + '.dat', ax[1,0], num_of_bins, 'power', params, True)
   
        params = [1.0, 1.74580523705]
        plot_max_impact_N(FOLDER + '/10_career_length_max_impact/career_length_max_user_rev'   + field + '_' + label + '.dat', ax[1,1], num_of_bins, 'power', params, True)
